...
A tabela a seguir mostra os principais valores que devem ser observados nos respectivos registadores para que o modo de operação do tipo de rede malha funcione para a nossa aplicação.
...
.. Tip::
   O registrador que configura qual a função do modem a ser utilizada no modo malha é o S101.
