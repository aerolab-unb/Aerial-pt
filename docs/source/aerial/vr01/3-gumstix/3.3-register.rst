...
:download:`Código para realização do teste de velocidade <teste2-gpio.c>`
...
Muito dificilmente alguma aplicação envolvendo GPIO não será satisfeita por algum dos métodos aqui apresentados, para finalizar este último tópico é necessário destacar um últimoproblema que ainda não foi resolvido envolvendo escrita em registradores.
