...
:download:`Download do código 1 comentado <teste1-gpio.c>`
...
:download:`Download do código 2 comentado <teste2-gpio.c>`
...
Este mesmo procedimento é aplicavel para o controle de clock de outros blocos de GPIO, sendo necessario apenas selecionar o endereço fisico do registrador correspondente, como pode ser visto na imagem abaixo.
