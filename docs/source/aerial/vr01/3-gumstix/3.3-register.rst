...
Resolução do problema descrito acima:

Usando o Technical Reference Manual (TRM) do processador DM3730, disponivel no site da Texas Instruments, como é explicado na seção 25.6.2 do TRM do processador DM3730, na página 3511, o gpio_ctrl pode ter seu clock dividido por certos valores pré-cadastrados, sendo eles 2, 4 ou 8.
