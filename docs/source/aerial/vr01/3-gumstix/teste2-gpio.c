...
% * <henriquepita9@gmail.com> 2018-07-03T21:22:24.877Z:
%
% ^ .
...
*(u32 *) ((u32)A+0x30+CONTROL_PADCONF_SYS_NIRQ_OFFSET)|=(0x00040000 ); //imposta mode 4 sul registro configurazione pad 186; habilita uso pin digitale
